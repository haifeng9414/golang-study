...
func TestMarshal(t *testing.T) {
	...
	tests := []struct {
		...
		{
			Record{true, 2.5, 0, 1 + 2i, 2 + 3i, "test", interface{}(5), Interface("test")},
			`((bee t) (F32 2.5) (F64 0) (C64 #C(1 2)) (C128 #C(2 3)) (S "test") (I ("interface {}" 5)) (II ("sexpr.Interface" "test")))`,
		},
		{
			Record{false, 0, 1.5, 0, 1i, "", interface{}(0), Interface("")},
			`((bee nil) (F32 0) (F64 1.5) (C64 #C(0 0)) (C128 #C(0 1)) (S "") (I ("interface {}" 0)) (II ("sexpr.Interface" "")))`,
		},
	}
...
func TestUnmarshal(t *testing.T) {
	...
	// 决定反序列化("sexpr.Interface" xxx)时将xxx视为什么值，这里为int，所以下面的测试中sexpr.Interface的值也只能为整数，否则如果是其他值，比如字符串，会报reflect: call of reflect.Value.SetString on int Value
	...
	tests := []struct {
		...
		{
			`((B t) (F32 2.5) (F64 0) (C64 #C(1 2)) (C128 #C(2 3)) (I ("sexpr.Interface" 1)))`,
			Record{true, 2.5, 0, 1 + 2i, 2 + 3i, Interface(1)},
		},
	}
	for _, test := range tests {
		var r Record
